...
export default function StaffGenerateReport(props) {
  ...
  const [employment_type, setEmploymentType] = useState([])
    ...
    const getStaff = (type) =>{
    axios.get(`http://localhost:5000/api/staff/empType/${type}`)
  ...
  return (
    ...
    <button type="button" onClick={()=>getStaff('Academic')} class="dbox_action_btn float-left"  >
                 Accademic
    </button>
    </div>
    <br/>
    <br/>
    <div style={{width:"200px",marginLeft:"80px"}}>
    <button type="button" onClick={()=>getStaff('nonAcademic')} class="dbox_action_btn float-left">
                 Non-Accademic
    </button>
    </div>
    <br/>
    ...
    <div style={{height:"500px",marginLeft:"100px",marginRight:"100px",marginTop:"30px"}}>
