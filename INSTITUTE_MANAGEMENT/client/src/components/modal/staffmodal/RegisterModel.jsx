  ...
  async function handleSubmit(e){
   ...
   const staffData ={
    ...
    if({employment_type} !== 'Academic'){
      ...
      if(employment_type.length === 0 || name.length === 0 || age.length === 0 || gender.length === 0  || email.length === 0  || address.length === 0 || basicSal.length === 0 || subCode.length === 0  || username.length === 0 || password.length === 0 || position.length === 0  ){
        swal(" Fields Cannot empty !","Please enter all data !", "error");
      }else{
        console.log(staffData);
        axios.post('http://localhost:5000/api/StaffAuth/register', staffData)
...
function demoData(e){
          setName('Nethmini');
          setAge('20');
          setCoreSubject('History');
          setEmailaddress('nethmini@gmail.com');
          setAddress('Horana');
          setBasicSal('Rs.25000');
          setSubCode('SUB008');
          setUserName('stf0012');
          setPassword('stf0012');
}
...
<br></br>
  ...
  <Form.Group as={Row} className="mb-3">
    ...
    <Col sm="5" >
      <Form.Control type="text" placeholder="Enter your age" value={age} onChange={(e)=>setAge(e.target.value)} id="datePickerId" />
    </Col>
  </Form.Group>
  ...
  <Form.Group as={Row} className="mb-3" >
    ...
    <Col sm="7">
      <Form.Control type="Email" placeholder="Enter your  Subject Code" disabled={radio === "nonAcademic"} value={subCode} onChange={(e)=>setSubCode(e.target.value)} />
    </Col>
  </Form.Group>
  ...
  <Form.Group as={Row} className="mb-3" >
    ...
    <Col sm="7">
      <Form.Control type="Email" placeholder="Enter your  Email Address" value={email} onChange={(e)=>setEmailaddress(e.target.value)} />
    </Col>
  </Form.Group>
  ...
  <Form.Group as={Row} className="mb-3" >
   ...
   Basic Salary
    ...
    <Col sm="7">
      <Form.Control   type="tel" placeholder="Enter your Salary" maxLength="10" value={basicSal}  onChange={(e)=>setBasicSal(e.target.value)} />
    </Col>
  </Form.Group>
  ...
  <Form.Group as={Row} className="mb-3" >
    ...
    <Col sm="7">
      <Form.Control   type="tel" placeholder="Enter your User Name" maxLength="10" value={username} onChange={(e)=>setUserName(e.target.value)} />
    </Col>
  </Form.Group>
  ...
  <Form.Group as={Row} className="mb-3" >
    ...
    <Col sm="7">
      <Form.Control   type="password" placeholder="Enter your Password" maxLength="10" value={password}  onChange={(e)=>setPassword(e.target.value)} />
    </Col>
  </Form.Group>
  </Col>
</Form>
