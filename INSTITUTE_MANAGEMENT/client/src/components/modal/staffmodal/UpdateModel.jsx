...
<Form.Group as={Row} className="mb-3" controlId="formPlaintextEmail">
  ...
  <Form.Group as={Row} className="mb-3" controlId="formPlaintextPassword">
    ...
    <Col sm="5">
      <Form.Control type="text" placeholder="Enter your core subject" value={core_subject} onChange={(e)=>{setCoreSubject(e.target.value)}} />
    </Col>
  </Form.Group>
  ...
  <Form.Group as={Row} className="mb-3" controlId="formPlaintextPassword">
    ...
    <Col sm="7">
      <Form.Control   type="text" placeholder="Enter your Position" value={position} onChange={(e)=>{setPosition(e.target.value)}}  />
    </Col>
  </Form.Group>
