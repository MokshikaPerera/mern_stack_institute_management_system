        ...
        <div>
            ...
            <div class="row">
                ...
                <div class="col-sm-8 d-flex">
                    {staff.map(stf=>(
                        <div key={stf.staffID} class="card" style={{ width: "15rem", height: "25rem" }}>
                            <div class="card-img-top">
                           
                            <img  src={PF+stf.profile_pic} className='img-fluid rounded' style={{height:"200px", width:"200px",marginLeft:"10px" }}alt=''  />
